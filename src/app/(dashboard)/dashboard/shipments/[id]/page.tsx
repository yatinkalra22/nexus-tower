      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-4 pt-4">
            ...
            <Separator />
            <div className="flex flex-col gap-1">
              <span className="text-xs text-muted-foreground uppercase font-semibold">Destination</span>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-4 pt-4">
            ...
            <Separator />
            <div className="flex flex-col gap-1">
              <span className="text-xs text-muted-foreground uppercase font-semibold">Vessel MMSI</span>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-4 pt-4">
            <div className="flex flex-col gap-1">
              <span className="text-xs text-muted-foreground uppercase font-semibold">Estimated Arrival (ETA)</span>
              <span className="font-medium">{shipment.eta ? shipment.eta.toLocaleString() : "TBD"}</span>
            </div>
            <Separator />
            <div className="flex flex-col gap-1">
              <span className="text-xs text-muted-foreground uppercase font-semibold">Created At</span>
